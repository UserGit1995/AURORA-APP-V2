  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md bg-[#0d1420] border border-[#1c2433] rounded-3xl shadow-2xl z-10 overflow-hidden my-auto"
      >
        {/* Close Button */}
        <button
          id="close-login-modal-btn"
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full text-slate-500 hover:text-white bg-[#111826]/80 hover:bg-[#1a2230] border border-[#1c2433] transition-colors z-20"
        >
          <X className="w-4 h-4" />
        </button>

        {/* Header with Official Aurora Logo */}
        <div className="pt-7 pb-3.5 px-6 text-center flex flex-col items-center border-b border-[#1c2433] bg-[#0d1420]/60">
          <div className="relative mb-2 p-1">
            <AuroraLogo size="login" showSubtitle={true} />
          </div>

          {/* Mode Switcher Tabs */}
          <div className="grid grid-cols-2 p-1 bg-[#0d1420] border border-[#1c2433] rounded-xl w-full max-w-xs mt-2.5">
            <button
              type="button"
              id="tab-login-btn"
              onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`p-2.5 rounded-xl border flex flex-col items-center text-center gap-1.5 transition-all cursor-pointer ${
                    customerType === 'privato'
                      ? 'bg-sky-500/15 border-sky-500 text-white shadow-sm ring-1 ring-sky-300'
                      : 'bg-[#0d1420] border-[#1c2433] text-slate-500 hover:text-white'
                  }`}
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500"
                    />
                  </div>
                </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 font-mono uppercase"
                      />
                    </div>
                  </>
                )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 font-mono"
                    />
                  </div>
                </div>
                  ...
                  {!showAdminCodeField ? (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#0d1420] border border-amber-500/40 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-amber-400 font-mono"
                      />
                    </div>
                  )}
                </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••••••"
                  className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl pl-10 pr-10 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 font-mono"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs text-slate-400 pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-slate-700 bg-[#0d1420] text-sky-500 focus:ring-0"
                />
        ...
        {/* Footer info */}
        <div className="p-3.5 bg-[#0d1420] border-t border-[#1c2433] text-center text-[11px] text-slate-500">
