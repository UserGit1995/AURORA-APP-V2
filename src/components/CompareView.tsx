      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              {comparedProducts.length > 0 && (
                <span className="text-xs font-bold bg-[#0d1420] text-sky-300 px-2.5 py-1 rounded-full border border-[#1c2433]">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="text-xs font-semibold text-sky-400 hover:text-sky-300 px-3.5 py-2 rounded-xl bg-[#0d1420] border border-[#1c2433] hover:border-sky-500/40 transition-colors"
          >
            ← Torna al catalogo
          </button>
          ...
          {comparedProducts.length > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-400 hover:text-rose-300 px-3.5 py-2 rounded-xl bg-[#0d1420] border border-[#1c2433] hover:border-rose-500/30 transition-colors"
            >
        ...
        <div className="bg-[#0d1420] border border-[#1c2433] rounded-3xl p-8 sm:p-12 text-center flex flex-col items-center justify-center shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
            ...
            <button
              ...
              onClick={() => setIsAddPickerOpen(true)}
              className="inline-flex items-center gap-2 bg-[#0d1420] hover:bg-[#1a2230] text-sky-300 border border-[#1c2433] text-xs sm:text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors"
            >
          ...
          <div className="w-full max-w-3xl pt-6 border-t border-[#1c2433]">
              ...
              {allProducts.slice(0, 3).map((prod) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[#0d1420] hover:bg-[#0284c7] text-sky-400 hover:text-white transition-colors"
          ...
          <div className="bg-[#0d1420] border border-[#1c2433] rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-md">
            <div className="flex items-center gap-3">
              <label 
                ...
                className="flex items-center gap-2 cursor-pointer select-none text-xs font-semibold text-slate-400 hover:text-white transition-colors"
              >
                <div className="relative">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-9 h-5 rounded-full transition-colors ${highlightDifferences ? 'bg-[#0284c7]' : 'bg-[#0d1420]'}`} />
                  <div className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-[#0e1b30] transition-transform ${highlightDifferences ? 'translate-x-4' : 'translate-x-0'}`} />
                </div>
          ...
          <div className="bg-[#0d1420] border border-[#1c2433] rounded-3xl overflow-hidden shadow-2xl">
            <div className="overflow-x-auto scrollbar-thin">
              <table className="w-full text-left border-collapse min-w-[640px]">
                ...
                <thead>
                  <tr className="border-b border-[#1c2433] bg-[#0d1420]">
                    <th className="p-4 sm:p-5 w-48 sm:w-60 text-xs font-bold text-slate-400 uppercase tracking-wider align-top bg-[#0d1420] border-r border-[#1c2433]">
                    ...
                    {comparedProducts.map((product) => {
                      ...
                      return (
                        <th
                          key={product.id}
                          className="p-4 sm:p-5 min-w-[220px] max-w-[280px] align-top relative group border-r last:border-r-0 border-[#1c2433]"
                        >
                          {/* Remove button */}
                          <button
                            id={`remove-compared-col-${product.id}`}
                            onClick={() => onRemoveFromCompare(product.id)}
                            className="absolute top-3 right-3 p-1.5 rounded-full bg-[#0d1420] hover:bg-rose-500/20 text-slate-400 hover:text-rose-300 border border-[#1c2433] transition-colors"
                    ...
                    {comparedProducts.length < 4 && (
                      <th className="p-4 sm:p-5 min-w-[200px] align-middle text-center bg-[#0d1420]/50">
                        <button
                          id="add-more-compare-slot-btn"
                          onClick={() => setIsAddPickerOpen(true)}
                          className="w-full h-full min-h-[220px] rounded-2xl border-2 border-dashed border-[#1c2433] hover:border-sky-500/50 bg-[#0d1420]/50 hover:bg-[#1a2230] flex flex-col items-center justify-center p-4 transition-all group"
                        >
                          <div className="w-10 h-10 rounded-full bg-[#0d1420] text-sky-400 flex items-center justify-center group-hover:scale-110 transition-transform mb-2">
                    ...
                    return (
                      <tr className={`hover:bg-[#1a2230]/50 ${diff && highlightDifferences ? 'bg-amber-500/10' : ''}`}>
                        ...
                        {comparedProducts.map((p) => (
                          <td key={p.id} className="p-3.5 sm:p-4 font-mono font-bold text-white border-r last:border-r-0 border-[#1c2433]">
                            €{p.price.toFixed(2)}
                            {diff && (
                  ...
                  {(() => {
                    ...
                    return (
                      <tr className={`hover:bg-[#1a2230]/50 ${diff && highlightDifferences ? 'bg-amber-500/10' : ''}`}>
                        ...
                        {comparedProducts.map((p) => (
                          <td key={p.id} className="p-3.5 sm:p-4 font-medium text-white border-r last:border-r-0 border-[#1c2433]">
                            <div className="flex items-center gap-1.5">
                  ...
                  {(() => {
                    ...
                    return (
                      <tr className={`hover:bg-[#1a2230]/50 ${diff && highlightDifferences ? 'bg-amber-500/10' : ''}`}>
                        ...
                        {comparedProducts.map((p) => (
                          <td key={p.id} className="p-3.5 sm:p-4 text-slate-300 border-r last:border-r-0 border-[#1c2433]">
                            {p.specs.format}
                          </td>
                        ))}
                        {comparedProducts.length < 4 && <td className="bg-[#0d1420]/50" />}
                  ...
                  {(() => {
                    ...
                    return (
                      <tr className={`hover:bg-[#1a2230]/50 ${diff && highlightDifferences ? 'bg-amber-500/10' : ''}`}>
                        ...
                        {comparedProducts.map((p) => (
                          <td key={p.id} className="p-3.5 sm:p-4 text-slate-400 border-r last:border-r-0 border-[#1c2433]">
                            {p.specs.fragrance ? (
                            ...
                            {p.specs.certifications && p.specs.certifications.length > 0 ? (
                              <div className="flex flex-wrap gap-1.5">
                                {p.specs.certifications.map((cert, idx) => (
                                  <span
                                    key={idx}
                                    className="inline-flex items-center gap-1 bg-[#0d1420] text-sky-300 border border-[#1c2433] px-2 py-0.5 rounded-md text-[10.5px] font-medium"
                                  >
                  ...
                  {(() => {
                    return (
                      <tr className="hover:bg-[#1a2230]/50">
                        ...
                        {comparedProducts.map((p) => (
                          <td key={p.id} className="p-3.5 sm:p-4 text-slate-400 leading-relaxed border-r last:border-r-0 border-[#1c2433] text-xs">
                            {p.description}
                          </td>
                        ))}
                        {comparedProducts.length < 4 && <td className="bg-[#0d1420]/50" />}
        ...
        {isAddPickerOpen && (
          <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#0d1420] border border-[#1c2433] rounded-3xl p-5 sm:p-6 shadow-2xl z-10 max-h-[85vh] flex flex-col"
            >
              <div className="flex items-center justify-between pb-4 border-b border-[#1c2433] mb-4">
                <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  onClick={() => setIsAddPickerOpen(false)}
                  className="p-1.5 rounded-xl text-slate-500 hover:text-white hover:bg-[#1a2230]"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-[#1c2433] flex justify-end">
                <button
                  onClick={() => setIsAddPickerOpen(false)}
                  className="px-4 py-2 rounded-xl text-xs font-semibold bg-[#0d1420] text-slate-400 hover:text-white"
                >
                  Chiudi
                </button>
              </div>
