...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="mt-16 border-t border-[#1c2433] bg-[#0d1420] text-slate-400 text-xs">
      {/* Top Value Strip */}
      <div className="border-b border-[#1c2433] bg-[#0d1420]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="flex items-center gap-3.5 p-3 rounded-2xl bg-[#0d1420]/70 border border-[#1c2433]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="pt-2">
              <div className="inline-flex flex-col p-3 rounded-2xl bg-[#0d1420] border border-[#1c2433] shadow-md space-y-2">
                ...
                <div className="flex items-center bg-[#0d1420] p-1 rounded-xl border border-[#1c2433] gap-1">
                  <button
