...
export const ProductEditModal: React.FC<ProductEditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-xs overflow-y-auto">
      <div 
        className="relative w-full max-w-3xl bg-slate-50 border border-amber-500/30 rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[92vh]"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 overflow-y-auto space-y-5 text-left text-sm flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-700 focus:border-amber-400 rounded-xl px-3.5 py-2.5 text-slate-900 font-medium text-sm outline-none transition-all"
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-700 focus:border-amber-400 rounded-xl px-3.5 py-2.5 text-slate-900 text-sm outline-none transition-all"
              >
                {categories.map((c) => (
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-700 focus:border-amber-400 rounded-xl px-3.5 py-2.5 text-slate-900 font-mono text-sm outline-none transition-all"
          ...
          {/* Pricing & Stock Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-50/60 p-4 rounded-2xl border border-slate-800">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-amber-500/40 rounded-xl px-3 py-2 text-slate-900 font-bold text-base outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-700 rounded-xl px-3 py-2 text-slate-900 font-bold text-base outline-none"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-700 rounded-xl px-3.5 py-2 text-slate-900 text-sm outline-none"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-700 focus:border-amber-400 rounded-xl px-3.5 py-2.5 text-slate-900 text-sm outline-none transition-all resize-y"
          ...
          <div className="flex flex-wrap gap-4 pt-2 border-t border-slate-800">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-xs text-slate-700 font-medium">In Evidenza nella Home</span>
            </label>
          ...
          <div className="bg-slate-50/40 p-3.5 rounded-2xl border border-slate-800">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {(formData.specs?.certifications || []).map((cert, idx) => (
                <span
                  key={idx}
                  className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg bg-sky-500/20 text-sky-700 border border-sky-500/30"
                >
                  {cert}
                  <button
                    type="button"
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-50 border border-slate-700 rounded-xl px-3 py-1.5 text-xs text-white outline-none"
              />
              <button
                type="button"
                onClick={handleAddCert}
                className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-700 text-xs font-bold rounded-xl"
              >
                + Aggiungi
              </button>
            </div>
