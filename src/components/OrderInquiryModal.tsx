  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-3 sm:p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl bg-[#0d1420] border border-[#1c2433] rounded-3xl p-5 sm:p-6 shadow-2xl z-10 max-h-[92vh] overflow-y-auto scrollbar-none flex flex-col"
      >
        {/* Header */}
              ...
              return (
                ...
                >
                  <div className={`p-1.5 rounded-lg shrink-0 mt-0.5 ${
                    isSelected ? 'bg-sky-500 text-white' : 'bg-[#0d1420] text-sky-400'
                  }`}>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl px-3 py-2 text-xs text-white placeholder-slate-500 focus:outline-hidden focus:border-sky-400 transition-colors"
          />
        </div>
        ...
        <div className="bg-[#0d1420] border border-[#1c2433] rounded-2xl p-4 mb-4 space-y-3 shadow-inner">
          <div className="flex items-center justify-between pb-2 border-b border-[#1c2433] text-xs">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={handleCopy}
                className="inline-flex items-center gap-1 text-[11px] font-semibold text-slate-400 hover:text-white px-2.5 py-1 rounded-lg bg-[#0d1420] hover:bg-[#1a2230] border border-[#1c2433] transition-colors"
              >
                {copied ? (
                  <>
          ...
          {/* Email Headers Meta */}
          <div className="space-y-1 text-xs bg-[#0d1420] p-2.5 rounded-xl border border-[#1c2433] font-mono">
          ...
          <div className="relative">
            <textarea
              ...
              value={body}
              rows={8}
              className="w-full bg-[#0d1420] border border-[#1c2433] rounded-xl p-3 text-xs text-slate-300 font-mono leading-relaxed resize-none focus:outline-hidden"
            />
          </div>
        </div>
        ...
        <div className="pt-3 border-t border-[#1c2433] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2.5 rounded-xl text-xs font-semibold bg-[#0d1420] hover:bg-[#1a2230] text-slate-400 hover:text-white transition-colors text-center"
          >
            Annulla
          </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-[#0d1420] hover:bg-[#1a2230] text-sky-200 border border-sky-500/30 transition-all shadow-xs"
